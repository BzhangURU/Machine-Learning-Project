...
public class hw1_C_method1_Bodong {
	...
	public static void main(String[] args) {
		...
		String[] data0=new String[total_Num];
		   ...
		   char replace_char=majority_char_at(data0,10);
		
	
		   
		   System.out.println("hw1_C_method1_Bodong     The majority character is "+replace_char);
		   //System.out.println("");
		...
		try {
			   ...
			   System.out.println("hw1_C_method1_Bodong     The depth of tree is  "+tree_depth);
			   ...
			   System.out.println("hw1_C_method1_Bodong     Depth Limit = "+depth_limit+"   No. "+sample_num+" Accuracy=  "+accuracies[sample_num]);
		...
		System.out.println("hw1_C_method1_Bodong     Average accuracy= "+average_accuracy);
		double std=0;
		for(int i=0;i<6;i++)
		{
		...
		std=std/6;
		std=Math.sqrt(std);
		System.out.println("hw1_C_method1_Bodong     Standard deviation= "+std);
		System.out.println("");
	...
	//Setting C   method 1
	public static char majority_char_at(String[] data0,int index)
	{
		...
		for(int i=0;i<data0.length;i++)
		{
			...
			{
				if(data0[i].charAt(index)==str_fea[index].charAt(k))//'?' is not in string, so no need to worry about '?'
					count0_num[k]++;
			}
		}
		
		char max_char=str_fea[index].charAt(0);
		int max_count_num=count0_num[0];
		for(int k=0;k<num_values;k++)
		{
