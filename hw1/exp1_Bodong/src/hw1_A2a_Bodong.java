...
public class hw1_A2a_Bodong {
	...
	public static int depth_limit=20;//limit max depth
	public static char majority;
	
	public static void main(String[] args) {
		
		String[] files=new String[]{"training_00.data","training_01.data","training_02.data","training_03.data","training_04.data","training_05.data"};
		...
		try {
			   ...
			   System.out.println("hw1_A2a_Bodong  The depth of tree is  "+tree_depth);
			   ...
			   System.out.println("Depth Limit = "+depth_limit+"   No. "+sample_num+" Accuracy=  "+accuracies[sample_num]);
		...
		System.out.println("Average accuracy= "+average_accuracy);
		double std=0;
		for(int i=0;i<6;i++)
		{
