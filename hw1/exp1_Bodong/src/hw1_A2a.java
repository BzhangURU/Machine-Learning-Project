...
public class hw1_A2a {
	...
	public static void main(String[] args) {
		...
		String[] data=new String[total_N*5];
		String[] test_data=new String[total_N];
		String new_str;
		int count=0;
		try {
			   ...
			   String str;
			   BufferedReader in;
			   in = new BufferedReader(new FileReader("training_00.data"));
			   ...
			   in = new BufferedReader(new FileReader("training_01.data"));
			   while ((str = in.readLine()) != null)
			   {
			       new_str=str.replace(",","");
			       data[count]=new_str;
			   ...
			   in = new BufferedReader(new FileReader("training_02.data"));
			   while ((str = in.readLine()) != null)
			   {
			       new_str=str.replace(",","");
			       data[count]=new_str;
			   ...
			   in = new BufferedReader(new FileReader("training_03.data"));
			   while ((str = in.readLine()) != null)
			   {
			       new_str=str.replace(",","");
			       data[count]=new_str;
			   ...
			   in.close();in = new BufferedReader(new FileReader("training_04.data"));
			   while ((str = in.readLine()) != null)
			   {
			       new_str=str.replace(",","");
			       data[count]=new_str;
			   ...
			   /*in = new BufferedReader(new FileReader("training_05.data"));
			   while ((str = in.readLine()) != null)
			   {
			       new_str=str.replace(",","");
			       data[count]=new_str;
			   ...
			   System.out.println("The depth of tree is  "+tree_depth);
			   
			   
			   count=0;
			   BufferedReader in_test = new BufferedReader(new FileReader("training_05.data"));
			   ...
			   double accuracy=get_accuracy(test_data,root_node);
