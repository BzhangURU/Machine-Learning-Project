...
public class hw1_C_method3_Bodong {
	//method 3, add'?' as character
	...
	public static void main(String[] args) {
		...
		/*String[] data0=new String[total_Num];
		   ...
		   System.out.println("The majority character is "+replace_char);*/
		...
		try {
			   ...
			   System.out.println("hw1_C_method3_Bodong     The depth of tree is  "+tree_depth);
			   ...
			   System.out.println("hw1_C_method3_Bodong     Depth Limit = "+depth_limit+"   No. "+sample_num+" Accuracy=  "+accuracies[sample_num]);
		...
		System.out.println("hw1_C_method3_Bodong     Average accuracy= "+average_accuracy);
		double std=0;
		for(int i=0;i<6;i++)
		{
		...
		std=std/6;
		std=Math.sqrt(std);
		System.out.println("hw1_C_method3_Bodong     Standard deviation= "+std);
		System.out.println("");
