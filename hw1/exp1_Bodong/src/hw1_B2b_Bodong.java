...
public class hw1_B2b_Bodong {
	...
	public static int depth_limit=1;//limit max depth
	public static void main(String[] args) {
		...
		try {//use training data to train
			   ...
			   BufferedReader in_test = new BufferedReader(new FileReader("B_test.data"));
			   ...
			   System.out.println("hw1_B2b_Bodong     Accuracy=  "+accuracy);
			   
			   System.out.println("hw1_B2b_Bodong     feature index=  "+root_node.feature_index);
			   System.out.println("");
