...
public class hw1_B1c_Bodong {
	...
	public static int total_test_N=3822;
	...
	public static void main(String[] args) {
		...
		try {//use training data to train
			   ...
			   BufferedReader in_test = new BufferedReader(new FileReader("training.data"));
			   ...
			   System.out.println("hw1_B1c_Bodong     Accuracy=  "+accuracy);
			   System.out.println("");
