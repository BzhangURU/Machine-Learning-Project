...
public class hw1_C3_Bodong {
	...
	public static int total_N=5434;
	public static int total_test_N=2690;
	...
	public static void main(String[] args) {
		...
		String[] test_data=new String[total_test_N];
		String new_str;
		int count=0;
		try {//use training data to train
			   BufferedReader in = new BufferedReader(new FileReader("C_training.data"));
			   String str;
			   ...
			   count=0;////use testing data to test
			   BufferedReader in_test = new BufferedReader(new FileReader("C_test.data"));
			   ...
			   System.out.println("hw1_C3_Bodong     Accuracy=  "+accuracy);
			   System.out.println("");
