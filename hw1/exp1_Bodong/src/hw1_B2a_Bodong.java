...
public class hw1_B2a_Bodong {
	...
	public static int depth_limit=10;//limit max depth
	public static char majority;
	
	public static void main(String[] args) {
		
		String[] files=new String[]{"B_training_00.data","B_training_01.data","B_training_02.data","B_training_03.data","B_training_04.data","B_training_05.data"};
		...
		try {
			   ...
			   System.out.println("hw1_B2a_Bodong     The depth of tree is  "+tree_depth);
			   ...
			   System.out.println("hw1_B2a_Bodong     Depth Limit = "+depth_limit+"   No. "+sample_num+" Accuracy=  "+accuracies[sample_num]);
		...
		System.out.println("hw1_B2a_Bodong     Average accuracy= "+average_accuracy);
		double std=0;
		for(int i=0;i<6;i++)
		{
		...
		std=std/6;
		std=Math.sqrt(std);
		System.out.println("hw1_B2a_Bodong     Standard deviation= "+std);
		System.out.println("");
