...
public class hw1_A1d_Bodong {
	...
	public static void main(String[] args) {
		...
		int count=0;
		try {
			   BufferedReader in = new BufferedReader(new FileReader("training.data"));
			   String str;
			   ...
			   System.out.println("hw1_A1d_Bodong  The depth of tree is "+tree_depth);
			   //System.out.println("The depth of tree is  "+tree_depth);
			   
			   
			   count=0;
			   BufferedReader in_test = new BufferedReader(new FileReader("test.data"));
			   ...
			   System.out.println("hw1_A1d_Bodong  Accuracy=  "+accuracy);
			   System.out.println("");
